# -*- coding: utf-8 -*-
"""
TWSEC Daily Information Crawler Library
...
from proxy.proxyq import ProxyQueue
from proxy.proxy_pool import ProxyPool
from lib.utils import year_generator
from lib.color_print import color_print
from lib.mylogger import MyLogger
from conf.settings import MYSQL_USER, MYSQL_PASSWORD


# Logger
logger = MyLogger(name='daily_crawler')

db = pymysql.connect('127.0.0.1', MYSQL_USER, MYSQL_PASSWORD, 'taiwan_stock',
                     charset='utf8')
cursor = db.cursor()
